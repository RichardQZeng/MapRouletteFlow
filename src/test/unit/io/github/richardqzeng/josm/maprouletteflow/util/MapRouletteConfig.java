...
public @interface MapRouletteConfig {
    class Extension extends WireMockExtension {
        ...
        private static String getDirectory() {
            ...
            final var pluginDirectory = Path.of("MapRouletteFlow");
            if (Files.isDirectory(pluginDirectory) && Files.isDirectory(pluginDirectory.resolve(basePath))) {
                return pluginDirectory.resolve(basePath).toString();
            }
        ...
        protected void onBeforeEach(WireMockRuntimeInfo wireMockRuntimeInfo) {
            io.github.richardqzeng.josm.maprouletteflow.config.MapRouletteConfig
                    .setInstance(new io.github.richardqzeng.josm.maprouletteflow.config.MapRouletteConfig(
        ...
        protected void onAfterEach(WireMockRuntimeInfo wireMockRuntimeInfo) {
            ...
            try {
                final Field instance = io.github.richardqzeng.josm.maprouletteflow.config.MapRouletteConfig.class
