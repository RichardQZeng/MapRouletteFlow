...
public class ApplyCooperativeChange {
    private static final String BULK_OPERATION_VERSION_MISMATCH = "maprouletteflow.command.cooperative-change";
    ...
    @Nullable
    public Command generateCommand(@Nonnull DataSet ds, BiPredicate<io.github.richardqzeng.josm.maprouletteflow.api.model.ElementUpdate, String> keep) {
        ...
        return commands.isEmpty() ? null : SequenceCommand.wrapIfNeeded(tr("MapRoulette Flow cooperative change"), commands);
    }
