...
import io.github.richardqzeng.josm.maprouletteflow.api.enums.Difficulty;
...
/**
 * Parser for {@link io.github.richardqzeng.josm.maprouletteflow.api.model.ClusteredPoint}
 */
public final class ClusteredPointParser {
    ...
    /**
     * Parse {@link io.github.richardqzeng.josm.maprouletteflow.api.model.ClusteredPoint}s from an {@link InputStream}
     *
     * @param inputStream The originating stream
     * @return The {@link io.github.richardqzeng.josm.maprouletteflow.api.model.ClusteredPoint}(s). Either an array or a single point.
     */
