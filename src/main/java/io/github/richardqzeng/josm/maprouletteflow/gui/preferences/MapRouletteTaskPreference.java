...
public class MapRouletteTaskPreference implements SubPreferenceSetting {
    private static final StringProperty NEXT_MODE = new StringProperty("maprouletteflow.task.next-mode", NextMode.RANDOM.name());
    private static final String NEXT_MODE_CHALLENGE = "maprouletteflow.task.next-mode.challenge.";
    private static final IntegerProperty POINT_RADIUS = new IntegerProperty("maprouletteflow.task.point-radius", 100);
    private static final IntegerProperty GEOMETRY_PADDING = new IntegerProperty("maprouletteflow.task.geometry-padding", 10);
    private static final BooleanProperty AUTO_CENTER = new BooleanProperty("maprouletteflow.task.auto-center", true);
    ...
    public void addGui(PreferenceTabbedPane gui) {
        ...
        getTabPreferenceSetting(gui).addSubTab(this, tr("Task Preferences"), panel,
                tr("MapRoulette Flow Task Preferences"));
    }
