...
import io.github.richardqzeng.josm.maprouletteflow.data.ApplyCooperativeChange;
import io.github.richardqzeng.josm.maprouletteflow.data.MergeDataSetsCommand;
import io.github.richardqzeng.josm.maprouletteflow.gui.MRGuiHelper;
import io.github.richardqzeng.josm.maprouletteflow.gui.TagChangeTable;
...
public final class CurrentTaskPanel extends JPanel {
    ...
    private boolean isCooperativeChangeKept(
            io.github.richardqzeng.josm.maprouletteflow.api.model.ElementUpdate update, String key) {
        for (var row = 0; row < cooperativeSelections.size(); row++) {
    ...
    private record CooperativeTagSelection(
            io.github.richardqzeng.josm.maprouletteflow.api.model.ElementUpdate update, String tag) {
        String key() {
