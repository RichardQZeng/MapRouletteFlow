...
import io.github.richardqzeng.josm.maprouletteflow.api.ProjectAPI;
...
public final class ProjectCache {
     ...
     */
    private static final CacheAccess<Long, Project> CACHE = JCSCacheManager.getCache("maprouletteflow:project");
