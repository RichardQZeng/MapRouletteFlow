...
public final class IgnoreList {
     ...
     * The ignored tasks
     */
    private static long[] ignoredTasks = convertList(Config.getPref().getList("maprouletteflow.ignore.tasks"));
    /**
     * The ignored challenges
     */
    private static long[] ignoredChallenges = convertList(Config.getPref().getList("maprouletteflow.ignore.challenges"));
    /**
    ...
    private static synchronized void save() {
        ...
        if (doSave) {
            Config.getPref().putList("maprouletteflow.ignore.tasks", convertList(tasks));
            Config.getPref().putList("maprouletteflow.ignore.challenges", convertList(challenges));
        }
    }
