...
import io.github.richardqzeng.josm.maprouletteflow.api.UserProgressAPI;
...
import io.github.richardqzeng.josm.maprouletteflow.data.IgnoreList;
import io.github.richardqzeng.josm.maprouletteflow.data.TaskPrimitives;
import io.github.richardqzeng.josm.maprouletteflow.gui.layer.MapRouletteClusteredPointLayer;
...
import io.github.richardqzeng.josm.maprouletteflow.gui.task.current.CurrentTaskPanel;
...
import io.github.richardqzeng.josm.maprouletteflow.workflow.ChallengeInputParser;
import io.github.richardqzeng.josm.maprouletteflow.workflow.ReservationLockRefresher;
import io.github.richardqzeng.josm.maprouletteflow.workflow.TaskDownloadService;
...
import io.github.richardqzeng.josm.maprouletteflow.workflow.WorkflowController.Snapshot;
...
public final class TaskListPanel extends ToggleDialog {
    ...
    private boolean coexistenceWarningShown;
    ...
    public TaskListPanel() {
        super(tr("MapRoulette Flow"), "maprouletteflow/plugin", tr("Focused MapRoulette challenge workflow"),
                Shortcut.registerShortcut("maprouletteflow:task_window", tr("MapRoulette Flow: Challenge workflow"),
    ...
    private void warnAboutOfficialPlugin() {
        if (!coexistenceWarningShown && PluginHandler.getPlugin("MapRoulette") != null) {
            coexistenceWarningShown = true;
            ConditionalOptionPaneUtil.showMessageDialog("maprouletteflow.official-plugin-enabled",
                    MainApplication.getMainFrame(),
                    tr("Official MapRoulette is also enabled. Keep only one MapRoulette task workflow active at a time."),
                    tr("MapRoulette Flow coexistence"), JOptionPane.WARNING_MESSAGE);
        }
    }
