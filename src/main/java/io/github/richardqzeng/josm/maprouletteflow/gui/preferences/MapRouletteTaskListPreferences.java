...
import io.github.richardqzeng.josm.maprouletteflow.api_caching.ProjectCache;
...
public class MapRouletteTaskListPreferences implements SubPreferenceSetting {
    ...
    public void addGui(PreferenceTabbedPane gui) {
        try {
            ...
            getTabPreferenceSetting(gui).addSubTab(this, tr("Exclusions"), pane, tr("MapRoulette Flow Exclusion Settings"));
