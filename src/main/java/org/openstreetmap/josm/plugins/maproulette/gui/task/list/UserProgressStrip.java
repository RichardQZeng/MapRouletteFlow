...
final class UserProgressStrip extends JPanel {
    ...
    private final JLabel primary = new JLabel(tr("MapRoulette progress"));
    ...
    void reset() {
        hasProgress = false;
        primary.setText(tr("MapRoulette progress"));
        secondary.setText(" ");
    ...
    void showUnavailable() {
        if (!hasProgress) {
            primary.setText(tr("MapRoulette progress unavailable"));
            secondary.setText(" ");
            badges.setAchievements(List.of());
        }
    }
    ...
    private static ImageIcon icon(Achievement achievement, int size) {
        return new ImageProvider("maproulette/achievements/" + achievement.imageName()).setSize(size, size)
    ...
    private static final class BadgeStack extends JPanel {
        ...
        BadgeStack() {
            ...
            setFocusable(true);
            setToolTipText(" ");
            getAccessibleContext().setAccessibleName(tr("MapRoulette achievements"));
